...
export function Header({ currentView }: HeaderProps) {
  ...
  return (
    <>
      ...
      <header className={`flex justify-between items-center w-full px-6 py-4 sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-[#FFCCBC] shadow-sm transition-all duration-700 ${isExiting ? 'opacity-0 scale-95 blur-sm' : 'opacity-100 scale-100'}`}>
